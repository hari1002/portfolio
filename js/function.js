...
$(function(){
    ...
    //design 라이트박스
    $(function(){
			const $btnImg = $('section#portfolio > .design > .container > .item > a');
			const $shadow = $('section#portfolio > .design > .container > .item > .shadow');
			const $lightbox = $('section#portfolio > .design > .container > .item > .shadow > .lightbox');
			const $btnClse = $('section#portfolio > .design > .container > .item > .shadow > .clse');

			$btnImg.on('click', function(evt){
					evt.preventDefault();
	...
	$(function(){
		const $btnImg = $('section#portfolio > .design > .container > .item_2 > a');
		const $shadow = $('section#portfolio > .design > .container > .item_2 > .shadow');
		const $lightbox = $('section#portfolio > .design > .container > .item_2 > .shadow > .lightbox');
		const $btnClse = $('section#portfolio > .design > .container > .item_2 > .shadow > .clse');
	...
	$(function(){
		const $btnImg = $('section#portfolio > .design > .container > .item_3 > a');
		const $shadow = $('section#portfolio > .design > .container > .item_3 > .shadow');
		const $lightbox = $('section#portfolio > .design > .container > .item_3 > .shadow > .lightbox');
		const $btnClse = $('section#portfolio > .design > .container > .item_3 > .shadow > .clse');
